...
type Outbox struct {
	ID                string         `json:"id"`
	OrganizationID    string         `json:"organizationID"`
	CampaignID        string         `json:"campaignID" gorm:"index:idx_campaign_status,option:CONCURRENTLY"`
	...
	Status            OutboxStatus   `json:"status"`
	StatusDescription string         `json:"statusDescription" gorm:"index:idx_campaign_status,option:CONCURRENTLY"`
